...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是一个产品经理, Hi，我是一个打工人, 欢迎来到我的博客🎉',
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '尘世之歌', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
