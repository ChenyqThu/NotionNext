...
const BLOG = {
  ...
  SINCE: process.env.NEXT_PUBLIC_SINCE || process.env.NEXT_SINCE || 2021, // e.g if leave this empty, current year will be used.
  ...
  TianliGPT_CSS: process.env.NEXT_PUBLIC_TIANLI_GPT_CSS || '/css/tianliGPT.css',
  TianliGPT_JS: process.env.NEXT_PUBLIC_TIANLI_GPT_JS || '/js/tianliGPT.js',
  ...
  COMMENT_TWIKOO_CDN_URL:
    process.env.NEXT_PUBLIC_COMMENT_TWIKOO_CDN_URL || 'https://cdn.jsdelivr.net/npm/twikoo@1.6.31/dist/twikoo.all.min.js', // twikoo客户端cdn
  ...
  UUID_REDIRECT: process.env.UUID_REDIRECT || false, // uuid路径是否重定向到slug
